                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="<?= base_url('User3/dataMutasi') ?>" class="row" method="POST">
                                        <?= token_csrf() ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form name="form_input" id="form_input" method="post" action="">
        ...
        <input type="hidden" name="back" id="back" value="<?= base_url('User3/dataMutasi'.($selectJenis!=''?'/'.encode($selectJenis):'')) ?>">
