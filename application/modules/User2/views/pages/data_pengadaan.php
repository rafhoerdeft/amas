                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td nowrap align="center">
                                                    ...
                                                    <a href="<?= base_url('User2/rincianPengadaan/'.encode($val->id_kontrak)) ?>"
                                                    ...
                                                    <!-- <button type="button" onclick="hapusData(this)"
                                                        ...
                                                        data-link="<?php //echo base_url('User2/deleteDataPengadaan'); ?>"
...
function addModal() {
    ...
    $('#modal_form #form_input').attr('action', "<?= base_url().'User2/simpanDataPengadaan'; ?>");
...
function editModal(data) {
    ...
    $('#modal_form #form_input').attr('action', "<?= base_url().'User2/updateDataPengadaan'; ?>");
