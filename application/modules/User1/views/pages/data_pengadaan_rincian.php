  ...
  <div class="content-wrapper">
    <div class="content-header row">
      ...
      <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
        <h3 class="content-header-title mb-0 d-inline-block">Rincian Pengadaan</h3>
        <div class="row breadcrumbs-top d-inline-block">
          <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="<?= base_url('User1') ?>">Dashboard</a></li>
              <li class="breadcrumb-item"><a href="<?= base_url('User1/dataPengadaan') ?>">Data Pengadaan</a></li>
            ...
            <div class="card">
              ...
              <div class="card-content collapse show">
                ...
                <div class="card-body">
                  ...
                  <table id="dataTable" class="table table-hover table-bordered table-striped" style="font-size: 8pt">
                    <thead>
                      ...
                      <?php $no=1; foreach ($dataKontrak as $val) { ?>
                        <tr>
                          ...
                          <td nowrap align="center">
                            <button type="button" onclick="hapusData(this)" data-id="<?= encode($val->id_kontrak) ?>" data-link="<?= base_url('User1/deleteDataKontrak') ?>" data-csrfname="<?= $this->security->get_csrf_token_name(); ?>" data-csrfcode="<?= $this->security->get_csrf_hash(); ?>" class="btn btn-sm btn-danger"  title="Hapus Data"><i class="la la-trash-o font-small-3"></i></button>

                            <button type="button" data-id="<?= encode($val->id_kontrak) ?>" data-nokontrak="<?= $val->no_kontrak ?>" data-nosp2d="<?= $val->no_sp2d ?>" data-nilai="<?= nominal($val->nilai_kontrak) ?>" data-rekanan="<?= $val->id_rekanan ?>" data-ppkom="<?= $val->id_user ?>" data-rekening="<?php //echo $val->jenis_rekening; ?>" onclick="editModal(this)" class="btn btn-sm btn-info" title="Update Data"><i class="la la-edit font-small-3"></i></button> 
                          </td>
                          ...
                          <!-- <td align="center"><?php //echo $val->jenis_rekening; ?></td> -->
                        </tr>
                      <?php } ?>
                    </tbody>
